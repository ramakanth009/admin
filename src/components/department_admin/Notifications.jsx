...
const useStyles = makeStyles({
  ...
  notificationHeader: {
    ...
    alignItems: 'center',
    padding: '12px 16px',
    backgroundColor: departmentColors.light + '15', // Very light green
  },
  notificationTitle: {
  ...
  unreadNotification: {
    borderLeft: `3px solid ${departmentColors.main}`,
    backgroundColor: departmentColors.light + '10', // Very light green
  },
...
const Notifications = () => {
  ...
  const getNotificationIcon = (type) => {
    ...
    switch(type) {
      ...
      default:
        return { color: departmentColors.main }; // Default green
    }
  };
                  ...
                  <ListItemText
                    ...
                    primary={
                      <Typography 
                        ...
                        sx={!notification.is_read ? { color: departmentColors.dark } : {}}
                      >
                        {notification.title}
                      </Typography>
                    }
