// src/components/common/ui/LoadingButton.jsx
import React, { useState, useEffect } from 'react';
import { Button, CircularProgress, Box } from '@mui/material';
import { getPrimaryColors } from '../../../utils/colors';

/**
 * Unified loading button component with theme support
 * 
 * @param {Object} props - Component props
 * @param {string} props.label - Button label
 * @param {string} props.loadingLabel - Label to show while loading
  ...
  return (
    <Button
      ...
      sx={{
        ...
        paddingTop: '12px',
        paddingBottom: '12px',
        backgroundColor: isLoading ? `${colors.main}` : undefined,
        '&:hover': {
          backgroundColor: isLoading ? `${colors.main}` : undefined,
        },
