// src/components/common/layout/Notifications.jsx
...
const useStyles = makeStyles({
  ...
  notificationHeader: {
    ...
    alignItems: 'center',
    padding: '12px 16px',
    backgroundColor: props => props.colors.light + '15', // Very light color with opacity
  },
  notificationTitle: {
  ...
  unreadNotification: {
    borderLeft: props => `3px solid ${props.colors.main}`,
    backgroundColor: props => props.colors.light + '10', // Very light color with opacity
  },
...
/**
 * Unified notifications component with role-based theming
 * 
 * @param {Object} props - Component props
 * @param {string} props.role - User role ('college_admin' or 'department_admin')
 */
const Notifications = ({ role = 'college_admin' }) => {
  ...
  const fetchNotifications = useCallback(async (isRefresh = false) => {
    ...
    try {
      ...
      setUnreadCount(2); // Default to 2 unread notifications
  ...
  const getNotificationIcon = (type) => {
    ...
    switch(type) {
      ...
      default:
        return { color: colors.main }; // Default theme color
    }
  };
                  ...
                  <ListItemText
                    ...
                    primary={
                      <Typography 
                        ...
                        sx={!notification.is_read ? { color: colors.dark } : {}}
                      >
                        {notification.title}
                      </Typography>
                    }
