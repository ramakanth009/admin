...
/**
 * Unified student details dialog component with role-based styling
 * 
 * @param {Object} props - Component props
 * @param {boolean} props.open - Whether the dialog is open
 * @param {function} props.handleClose - Function to close the dialog
 * @param {Object} props.selectedUser - The selected user to display details for
 * @param {Object} props.userDetails - The detailed user data to display
 * @param {boolean} props.loadingDetails - Whether details are being loaded
              ...
              <Grid item xs={12} md={6}>
                <Card className={classes.infoCard} elevation={2}>
                  <CardContent>
                    ...
                    {/* Department rank field - displayed differently based on role */}
                    <Box className={classes.labelValue}>
                      <Typography className={classes.label}>Department Rank:</Typography>
                      <Typography className={classes.value}>
                        {isCollegeAdmin ? userDetails.profile.department_rank : userDetails.profile.rank_in_department}
                      </Typography>
                    </Box>
